...
public:
  ...
  void add_color_rgba8(const std::uint8_t* colors, int num_points);
  ...
  void add_buffer(const std::string& attribute_name, int dim, GLenum type, GLboolean normalized, const void* data, int stride, int num_points);
